    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="blogreactApp.tag.home.createOrEditLabel">
              <Translate contentKey="blogreactApp.tag.home.createOrEditLabel">Create or edit a Tag</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : tagEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="nameLabel" for="name">
                    <Translate contentKey="blogreactApp.tag.name">Name</Translate>
                  </Label>
                  <AvField
                    id="tag-name"
                    type="text"
