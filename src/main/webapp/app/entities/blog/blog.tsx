...
export class Blog extends React.Component<IBlogProps, IBlogState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="blog-heading">
          <Translate contentKey="blogreactApp.blog.home.title">Blogs</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="blogreactApp.blog.home.createLabel">Create new Blog</Translate>
          </Link>
        </h2>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('title')}>
                  <Translate contentKey="blogreactApp.blog.title">Title</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('description')}>
                  <Translate contentKey="blogreactApp.blog.description">Description</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
